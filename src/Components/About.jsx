...
//                         <button type="button" class="btn btn-lg btn-primary mb-3 mb-md-4 mb-xl-5" id={style.dis}>Discover More</button>
//                     </div>
//                     </div>
//                 </div>
...
//                             <img class="card-img-top img-fluid m-0" loading="lazy" src={image1} alt="Our Vision" />
...
//                             <img class="card-img-top img-fluid m-0" loading="lazy" src={image2} alt="Our Approach"/>
//                             <div class="card-body border bg-white p-4">
//                             <div class="entry-header mb-3">
//                                 <h2 class="card-title entry-title h4 mb-0">
