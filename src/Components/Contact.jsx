                            ...
                            <div class="container ">
                                ...
                                <div class="col-12 col-lg-6  ">
                                    ...
                                    <form action="#!">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <label for="phone" class="form-label" style={{color:"white"}}>Phone Number <span class="text-danger">*</span> </label>
                                            <div class="input-group">
                                            <span class="input-group-text">
                                        ...
                                        <div class="col-12">
                                            <label for="subject" class="form-label" style={{color:"white"}}>Subject <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="subject" name="subject" value="" required/>
                                        </div>
                                        <div class="col-12">
                                            <label for="message" class="form-label" style={{color:"white"}}>Message <span class="text-danger">*</span></label>
